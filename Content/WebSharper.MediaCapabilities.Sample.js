...
function Main(){
  ...
  const this_1=(t.h.push(EventQ2(t.k, "checkmedia", () => t.i, () => {
    const _3=null;
    StartImmediate(Delay(() => Bind(AsAsync(checkMedia()), () => Return(null))), null);
  })),t);
  const b=(this_1.h.push(new TextView("result", resultMessage().View)),this_1);
...
function checkMedia(){
  ...
  return new Promise((_2) => {
    ...
    let _3=new Promise((_4) => {
      ...
      const a=unwrapExn(d);
      resultMessage().Set("\u274c Error: "+String(a.message));
      return Promise.resolve(null);
    });
    _2(_3);
  });
